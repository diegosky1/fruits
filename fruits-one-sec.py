...
do = pygame.mixer.Sound('samples/Do-1seg.wav')
do.set_volume(85);
re = pygame.mixer.Sound('samples/Re-1seg.wav')
re.set_volume(85);
mi = pygame.mixer.Sound('samples/Mi-1seg.wav')
mi.set_volume(85);
fa = pygame.mixer.Sound('samples/Fa-1seg.wav')
fa.set_volume(85);
sol = pygame.mixer.Sound('samples/Sol-1seg.wav')
sol.set_volume(85);
