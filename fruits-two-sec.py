...
do = pygame.mixer.Sound('samples/Do.wav')
do.set_volume(85);
re = pygame.mixer.Sound('samples/Re.wav')
re.set_volume(85);
mi = pygame.mixer.Sound('samples/Mi.wav')
mi.set_volume(85);
fa = pygame.mixer.Sound('samples/Fa.wav')
fa.set_volume(85);
sol = pygame.mixer.Sound('samples/Sol.wav')
sol.set_volume(85);
